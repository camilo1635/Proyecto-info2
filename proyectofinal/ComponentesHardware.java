...
public class ComponentesHardware extends Producto {
    ...
    public String toString() {
        return "\nComponentesHardware{" + "idproducto=" + idproducto + ", nombre=" + nombre + ", descripcion=" + descripcion + ", precio=" + precio + ", stock=" + stock + ", capacidad=" + capacidad + ", velocidad_reloj=" + velocidad_reloj + ", interfaz=" + interfaz + ", modelo=" + modelo + '}';
    }
