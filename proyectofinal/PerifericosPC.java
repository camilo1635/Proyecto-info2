...
public class PerifericosPC extends Producto {
    ...
    public String toString() {
        return "\nPerifericosPC{" + "idproducto=" + idproducto + ", nombre=" + nombre + ", descripcion=" + descripcion + ", precio=" + precio + ", stock=" + stock + ", tipo_conexion=" + tipo_conexion + ", fabricante=" + fabricante + ", numero_de_puertos=" + numero_de_puertos + ", color=" + color + '}';
    }
